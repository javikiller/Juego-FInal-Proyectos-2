...
public class Movimiento1 : MonoBehaviour
{
    ...
    public string moverese = "moverse";
    public string corre = "correr";
    public string def = "defense";
    ...
    void FixedUpdate ()  
    {
        ...
        if (pj == true)
        {
            ...
            animator.SetFloat(corre, SpeedAux, StartAnimTime, Time.deltaTime);
            ...
            {
                animator.SetFloat(corre, 0, StartAnimTime, Time.deltaTime);
            }
        }
        if (!pj)
        {
    ...
    public void Jump()
    {
        ...
        {
            rb.AddForce(rb.transform.up * 350 * 1.3f);            
            jumpxOn1 = true;
    ...
    public void MovementFunction()
    {
        ...
        {
            rb.AddForce((mira.transform.forward * Input.GetAxis("L_YAxis_1") * -Velocidad * 1.3f));
        ...
        {
            rb.AddForce((mira.transform.right * Input.GetAxis("L_XAxis_1") * Velocidad * 1.3f));
            if (Input.GetButton("LS_1") && ground)
            {
